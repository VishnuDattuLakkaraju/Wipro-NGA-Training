...
class MethodDemo {
    public static void main(String[] args) {
       MethodCalling call = new MethodCalling();
    //    calc.add(5, 10); // Method Call with 
    //    calc.greet();// Methos Calling without Arguments
         call.hello("Alice","Welcome to Java Programming!",3);
         int result = call.multiply(4, 5);
         System.out.println("Multiplication Result: " + result);
         String message = call.getGreetingMessage("Bob");
